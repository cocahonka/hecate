...
func (_mock *MockTokenGenerator) Generate(user domain.User) (string, string, error) {
	...
	var r1 string
	var r2 error
	if returnFunc, ok := ret.Get(0).(func(domain.User) (string, string, error)); ok {
...
func (_c *MockTokenGenerator_Generate_Call) RunAndReturn(run func(user domain.User) (string, string, error)) *MockTokenGenerator_Generate_Call {
	_c.Call.Return(run)
	return _c
}
